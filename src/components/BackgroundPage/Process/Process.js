    ...
    return (
      <div className={dash.content}>
        <div className={dash.form}>
          <div className={dash.nameBlock}>{process.name}</div>
          <div className={dash.data}>
            <div className={dash.firstData}>
              <Circle className={dash.icon} />
              <span className={dash.firstNumb}>
            ...
            <div className={dash.secondData}>
              <div>
                ...
                <span className={dash.numb}>{averageLeadTimeStr}</span>
            ...
            <div className={dash.secondData}>
              <div>
                <span className={dash.numb}>
                  ...
                  {this.declOfNum(process.employeesInvolvedProcess, [
                    "сотрудников",
                    "сотрудника",
                    "сотрудников",
                  ])}
